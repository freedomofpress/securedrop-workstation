...
Source0:	securedrop-workstation-dom0-config-0.6.3.tar.gz
...
%prep
%setup -n securedrop-workstation-dom0-config-0.6.3
...
%changelog
* Thu Jun 23 2022 SecureDrop Team <securedrop@freedom.press> - 0.6.3
- Use latest keyring for provisioning RPM (Qubes 4.0)
