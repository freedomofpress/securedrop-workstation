...
Source0:	securedrop-workstation-dom0-config-0.3.1rc1.tar.gz
...
%prep
%setup -n securedrop-workstation-dom0-config-0.3.1rc1
...
%changelog
* Wed Jun 10 2020 SecureDrop Team <securedrop@freedom.press> - 0.3.1-rc1
