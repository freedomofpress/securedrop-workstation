...
install -m 644 files/press.freedom.SecureDropUpdaterApp.desktop %{buildroot}/%{_datadir}/applications/
install -m 644 files/press.freedom.SecureDropUpdaterApp.desktop %{buildroot}/srv/salt/securedrop_salt/press.freedom.SecureDropUpdaterApp.desktop
...
%attr(644, root, root) %{_datadir}/applications/press.freedom.SecureDropUpdaterApp.desktop
...
%changelog
* Thu Dec 11 2025 SecureDrop Team <securedrop@freedom.press> - 1.6.0rc1
- See changelog.md

* Wed Dec 10 2025 SecureDrop Team <securedrop@freedom.press> - 1.5.1
- See changelog.md

* Thu Oct 16 2025 SecureDrop Team <securedrop@freedom.press> - 1.5.0
- See changelog.md
...
* Thu Feb 27 2025 SecureDrop Team <securedrop@freedom.press> - 1.1.1
- See changelog.md

* Wed Feb 26 2025 SecureDrop Team <securedrop@freedom.press> - 1.1.0
- See changelog.md
