...
Source0:	securedrop-workstation-dom0-config-0.4.0rc1.tar.gz
...
%prep
%setup -n securedrop-workstation-dom0-config-0.4.0rc1
...
%changelog
* Mon Jun 29 2020 SecureDrop Team <securedrop@freedom.press> - 0.4.0-rc1
