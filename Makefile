...
build-rpm-docker: ## Builds local docker container with injected userid
	@./scripts/rpm-docker-build

build-dom0-rpm: build-rpm-docker ## Builds rpm package to be installed on dom0
	@./scripts/rpm-dom0-package
