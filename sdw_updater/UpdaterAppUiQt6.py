...
# NOTE: the following was manually addded on top of the autogenerated code
try:
...
class Ui_UpdaterDialog:
    def setupUi(self, UpdaterDialog):
        ...
        self.rebootButton = QtWidgets.QPushButton(parent=UpdaterDialog)
        ...
        self.applyUpdatesButton = QtWidgets.QPushButton(parent=UpdaterDialog)
        ...
        self.cancelButton = QtWidgets.QPushButton(parent=UpdaterDialog)
        self.cancelButton.setStyleSheet("")
        self.cancelButton.setAutoDefault(True)
        self.cancelButton.setObjectName("cancelButton")
        self.gridLayout.addWidget(self.cancelButton, 7, 5, 1, 1)
        self.progressBar = QtWidgets.QProgressBar(parent=UpdaterDialog)
        self.progressBar.setProperty("value", 0)
        self.progressBar.setObjectName("progressBar")
        self.gridLayout.addWidget(self.progressBar, 2, 1, 1, 5)
        self.headline = QtWidgets.QLabel(parent=UpdaterDialog)
        sizePolicy = QtWidgets.QSizePolicy(
        ...
        font.setWeight(600 if _QT6 else 75)
