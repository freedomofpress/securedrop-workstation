...
description_status_updates_available = ("Before you use SecureDrop on this computer, "
...
description_status_applying_updates = ("You will see system notifications while the "
...
description_status_updates_complete = ("Updates to critical system components have "
                                       "been applied. It is now safe to use SecureDrop "
                                       "on this computer.")
label_status_security_updates_failed = "Security updates failed"
description_status_security_updates_failed = ("There was a problem applying security "
...
description_error_lauching_client = ("An error has occurred when trying to launch "
